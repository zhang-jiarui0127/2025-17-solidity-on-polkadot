 ...
 * @returns 
 */
export async function deployContractByEthers(abi: any[], bytecode: string, wallet: ethers.Wallet) {
 ...
 * @returns 
 */
export async function deployContractByViem(abi: any[], bytecode: Hex, publicClient: PublicClient, walleClient: WalletClient) {
